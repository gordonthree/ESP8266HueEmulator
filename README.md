...
This fork is intended to convert the original Arduino sketch into a PlatformIO format. Also forking the aJSON library for the modified buffer length requirement.
